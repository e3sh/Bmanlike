class uiScene extends Phaser.Scene {
  ...
  */
  ...
  create() {
    ...
    this.gText = this.add.bitmapText(112+0, 0, 'pcgfont', 'UI_text');//600-48
    this.gText.setScale(1);
    this.bar = this.add.bitmapText(112+8*16, 0, 'pcgfont', 'hp_bar');
    this.bar.setScale(1);
    ...
    const sp = spg.get(140, 8,"sp_asset");
  ...
  update() {
    ...
    this.bar.setText(
      "" + "&".repeat(basehp/30) + "\n" //this.gameMain.result + "\n"//this.gameMain.invitems + "/" + this.gameMain.fielditemMax + "\n"        
      + "#".repeat(basehp%30) + "\n"
