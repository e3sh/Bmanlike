class UIDebugScene extends Phaser.Scene {
    ...
    create() {
      ...
      this.bombs = gamemain.bombs;
      this.fires = gamemain.fires;
    ...
    gamemain.toptile.setVisible(!this.homekey);
    ...
    let spritestatus = "-- SpriteStatus --\n"
      ...
      +"bombs:" + this.bombs.getLength() + "/" +this.bombs.getTotalUsed() + "\n" + poslist(this.bombs)
      +"fires:" + this.fires.getLength() + "/" +this.fires.getTotalUsed() + "\n" + poslist(this.fires);
